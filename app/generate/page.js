...
export default function Generate() {
  ...
  return (
    ...
    >
      ...
      >
        <Typography variant="h4" sx={{ fontWeight: 'bold', color: '#BD38AC', mb: 2 }}>
          Generate Flashcards
        </Typography>
        <Paper sx={{ p: 4, width: '100%', boxShadow: 3, borderRadius: 2 }}>
          ...
          <Button
            ...
            fullWidth
            sx={{ boxShadow: 2,background:'#BD38AC' }}
          >
            Submit
          </Button>
        </Paper>
      ...
      {flashcards.length > 0 && (
        <Box sx={{ mt: 4, width: '100%' }}>
          <Typography variant="h5" component="h2" gutterBottom sx={{ color: '#BD38AC', textAlign: 'center' }}>
            Flashcards Preview
          </Typography>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <DialogContentText>
            Name your flashcards collection
          </DialogContentText>
          <TextField 
            autoFocus 
            margin="dense" 
